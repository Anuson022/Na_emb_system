...
function ShirtOrderScout({ cus_id, parent_name, phone_number, status }) 
{
      ...
      <div className="container_form" style={{alignItems:'center'}}>
        ...
        <div className="body_shirt">
          ...
          <div className="shirt_design">
            ...
            <div className="grid_name" style={{bottom:'30.5rem'}}>
              <div className="on_right">
                ...
                >
                  <div style={{borderStyle:'solid',borderWidth:'4px',
                    borderColor:Scoutdata.SName.color_border,fontSize:'1rem',
...
export default ShirtOrderScout;
